...
x0 = tk.IntVar()
tk.Label(root, text = " Cận ", font = ('Times new roman', 13), bg = 'orange', fg = 'Black', width = 6, height = 1, relief='solid', borderwidth = 2).place(x = 60, y = 185)
